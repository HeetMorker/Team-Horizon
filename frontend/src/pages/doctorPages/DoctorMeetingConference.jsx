...
const DoctorMeetingConference = () => {
  ...
  const fetchAppointmentDetails = async () => {
    try {
      const response = await axios.get(`https://team-horizon.onrender.com/api/appointments/${appointmentId}`); // Assuming you have a backend route to get appointment details

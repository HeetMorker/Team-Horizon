  ...
  useEffect(() => {
    const fetchDoctorData = async () => {
      try {
        ...
        // Set preview images
        setProfileImagePreview(`https://team-horizon.onrender.com/${doctor.profileImage}`);
        setSignatureImagePreview(`https://team-horizon.onrender.com/${doctor.signatureImage}`);
